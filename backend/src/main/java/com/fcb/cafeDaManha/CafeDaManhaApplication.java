...
public class CafeDaManhaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Colaborador col1 = new Colaborador(null, "Felipe", "168.866.390-80", "123456");
		Colaborador col2 = new Colaborador(null, "Maria", "802.295.340-74", "123456");
		Colaborador col3 = new Colaborador(null, "Rose", "214.497.880-84", "123456");
